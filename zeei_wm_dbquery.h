#ifndef ZEEI_WM_DBQUERY_H
#define ZEEI_WM_DBQUERY_H
...
class DbHpler;
namespace Ui {
class ZEEI_WM_DbQuery;
}

class ZEEI_WM_DbQuery : public QWidget
{
    Q_OBJECT
    
public:
    explicit ZEEI_WM_DbQuery(QWidget *parent = 0);
    ~ZEEI_WM_DbQuery();
