...
#ifndef UI_ZEEI_WM_DBQUERY_H
#define UI_ZEEI_WM_DBQUERY_H
...
public:
    ...
    void setupUi(QWidget *ZEEI_WM_DbQuery)
    {
        if (ZEEI_WM_DbQuery->objectName().isEmpty())
            ZEEI_WM_DbQuery->setObjectName(QString::fromUtf8("ZEEI_WM_DbQuery"));
        ZEEI_WM_DbQuery->resize(1440, 800);
        gridLayout = new QGridLayout(ZEEI_WM_DbQuery);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 2, 0);
        widgetLeft = new QWidget(ZEEI_WM_DbQuery);
...
"}"));
        ...
        stackedWidget = new QStackedWidget(ZEEI_WM_DbQuery);
        ...
        retranslateUi(ZEEI_WM_DbQuery);

        QMetaObject::connectSlotsByName(ZEEI_WM_DbQuery);
    } // setupUi

    void retranslateUi(QWidget *ZEEI_WM_DbQuery)
    {
        ZEEI_WM_DbQuery->setWindowTitle(QApplication::translate("ZEEI_WM_DbQuery", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ZEEI_WM_DbQuery", "\345\274\200\345\247\213", 0, QApplication::UnicodeUTF8));
        dteBegin->setDisplayFormat(QApplication::translate("ZEEI_WM_DbQuery", "yy/M/d H:mm:ss", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("ZEEI_WM_DbQuery", "\347\273\223\346\235\237", 0, QApplication::UnicodeUTF8));
        dteEnd->setDisplayFormat(QApplication::translate("ZEEI_WM_DbQuery", "yy/M/d H:mm:ss", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("ZEEI_WM_DbQuery", "\346\230\276\347\244\272", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("ZEEI_WM_DbQuery", "\346\250\241\345\274\217", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("ZEEI_WM_DbQuery", "\345\233\240\345\255\220", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("ZEEI_WM_DbQuery", "\346\265\213\347\202\271", 0, QApplication::UnicodeUTF8));
        checkBox->setText(QApplication::translate("ZEEI_WM_DbQuery", "\346\230\276\347\244\272\346\225\260\346\215\256\346\240\207\350\257\206", 0, QApplication::UnicodeUTF8));
        btnSelect->setText(QApplication::translate("ZEEI_WM_DbQuery", "\346\237\245\350\257\242", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ZEEI_WM_DbQuery: public Ui_ZEEI_WM_DbQuery {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ZEEI_WM_DBQUERY_H
